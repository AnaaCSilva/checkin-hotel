...
<head>
    ...
    <title>
        <c:choose>
            <c:when test="${empty hospede.id}">Novo hospede</c:when>
            <c:otherwise>Editar hospede</c:otherwise>
        </c:choose>
        - Check-in Hotel
    </title>
        ...
        <form method="post" action="${pageContext.request.contextPath}/hospedes">
            ...
            <div class="form-group">
                ...
                <select id="tipoDocumento" name="tipoDocumento" required>
                    ...
                    <option value="CPF" ${hospede.tipoDocumento == 'CPF' ? 'selected' : ''}>CPF</option>
                    <option value="PASSAPORTE" ${hospede.tipoDocumento == 'PASSAPORTE' ? 'selected' : ''}>Passaporte</option>
                </select>
            </div>

            <div class="form-group">
                <label for="numeroDocumento">Número do documento</label>
                <input type="text" id="numeroDocumento" name="numeroDocumento" value="${hospede.numeroDocumento}" required>
            </div>
            ...
            <div class="actions">
                ...
                <a class="btn btn-secondary" href="${pageContext.request.contextPath}/hospedes">Cancelar</a>
            </div>
        </form>
    </div>
</main>
